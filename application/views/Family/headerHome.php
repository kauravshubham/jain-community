...
<head>
       ...
       <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.3/css/all.css" integrity="sha384-UHRtZLI+pbxtHCWp1t77Bi1L4ZtiqrqD80Kn4Z8NTSRyMA2Fd33n5dQ8lWUE00s/" crossorigin="anonymous">
        ...
        <script src="<?php echo base_url(); ?>assets/js/Member_list.js"></script>
...
<!--mobile logo -->
    <div class="mobile-logo">
        <a href=""><img src="<?php echo base_url(); ?>jain_community/assets/img/mobile-logo.png" alt="Logo Image Will Be Here"></a>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-8 text-right"> 
                    <nav>
                        ...
                        <li><a href="<?php echo base_url(); ?>FamilyMembers">My Family</a></li>
                        <li><a href="<?php echo base_url(); ?>MyNewFamily">New Family</a></li>
